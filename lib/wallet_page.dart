...
const List<CoinProduct> kCoinProducts = [
  CoinProduct(productId: 'Custy', coins: 32, price: 0.99, priceText: '\$0.99'),
  CoinProduct(productId: 'Custy1', coins: 60, price: 1.99, priceText: '\$1.99'),
  CoinProduct(productId: 'Custy2', coins: 96, price: 2.99, priceText: '\$2.99'),
  CoinProduct(productId: 'Custy4', coins: 155, price: 4.99, priceText: '\$4.99'),
  CoinProduct(productId: 'Custy5', coins: 189, price: 5.99, priceText: '\$5.99'),
  CoinProduct(productId: 'Custy9', coins: 359, price: 9.99, priceText: '\$9.99'),
  CoinProduct(
    productId: 'Custy19',
    coins: 729,
    price: 19.99,
                ...
                Container(
                  ...
                  child: const Center(
                    child: CircularProgressIndicator(
                      valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF933996)),
                    ),
                  ),
                ),
            ],
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            _CoinRule(
              number: '1',
              text: 'Create New Trip需要消耗120Coins',
            ),
            SizedBox(height: 16),
            _CoinRule(
              number: '2',
              text: '解锁部分旅游作品需要200Coins',
            ),
            SizedBox(height: 16),
            _CoinRule(
              number: '3',
